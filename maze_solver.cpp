...
/**
 * @brief
 * @param maze the maze object in which the algorithm is performed
 * @param currX the x-coord for the starting point
 * @param currY the y-coord for the starting point
 * @param tarX the x-coord for the ending point
 * @param tarY the y-coord for the ending point
 * 
 */
...
// generate maze will return a generated maze
vector<vector<char>> generateMaze(int width, int height) {

    // alocate memory for the maze
